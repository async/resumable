...
2. Read [specs/framework-design.md](../../../specs/framework-design.md), then the narrow spec files for the current task.
3. Implement the smallest vertical slice that proves behavior. Avoid future infrastructure unless the active spec requires it.

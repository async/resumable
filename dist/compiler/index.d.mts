...
import { h as RenderedPayloadScripts } from "../index-tOevUKQ5.mjs";
...
type SemanticTemplateBindingTarget = {
  readonly kind: 'text';
} | {
...
type SemanticSyncPolicyConstant = {
  readonly name: string;
  readonly value: unknown;
};
...
type SymbolModulesInput = {
  readonly symbolResolver: SymbolResolverPlan;
  readonly captureAnalysis: CaptureAnalysisArtifact;
};
type GeneratedSymbolModule = {
  readonly symbolId: string;
  readonly kind: PlannedSymbol['kind'];
  readonly exportName: string;
  readonly source: string;
};
type SymbolModulesArtifact = {
...
type CompilerPassGraphErrorReason = 'duplicate-pass-id' | 'duplicate-artifact-producer' | 'missing-artifact' | 'dependency-cycle';
type CompilerPassGraphDiagnostic = {
...
declare class CompilerPassGraphError extends Error implements CompilerPassGraphDiagnostic {
  readonly code: "AA_COMPILER_PASS_GRAPH_INVALID";
  readonly severity: "error";
  readonly phase: "runtime";
  readonly title: "Invalid compiler pass graph";
...
//#endregion
//#region packages/compiler/src/passes/symbol-modules.d.ts
declare function emitSymbolModules(input: SymbolModulesInput): SymbolModulesArtifact;
//#endregion
...
//#endregion
export { CaptureAnalysisArtifact, CaptureAnalysisDiagnostic, CaptureAnalysisInput, CompileTsrxModuleInput, CompileTsrxModuleResult, type CompilerDiagnostic, CompilerPassDefinition, CompilerPassGraph, CompilerPassGraphError, type DiagnosticSuggestion, GeneratedSymbolModule, LoweredStateRead, LoweredStateWrite, PayloadArenaArtifact, PayloadArenaDiagnostic, PayloadArenaInput, PayloadAsyncBoundary, PayloadScriptsArtifact, PayloadScriptsInput, PlannedSymbol, ProtocolStatePayloadInput, ProtocolViewPayloadInput, SemanticComponent, SemanticElementHandleBinding, SemanticEvent, SemanticGraphAlias, SemanticGraphArtifact, SemanticGraphBinding, SemanticGraphDependency, SemanticGraphDiagnostic, SemanticGraphInput, SemanticHostNode, SemanticLocalBinding, SemanticStateRead, SemanticStateWrite, SemanticSyncPolicy, SemanticSyncPolicyAction, SemanticSyncPolicyBranch, SemanticSyncPolicyCondition, SemanticSyncPolicyConstant, SemanticTemplateBindingTarget, SemanticTemplateRead, type SourceSpan, StateLoweringArtifact, StateLoweringDiagnostic, StateLoweringInput, SymbolModulesArtifact, SymbolModulesInput, SymbolResolverInput, SymbolResolverModuleInput, SymbolResolverModuleManifest, SymbolResolverPlan, analyzeCaptures, buildSemanticGraph, compileTsrxModule, createProtocolStatePayloadFromArena, createProtocolViewPayload, createSymbolResolverModuleManifest, defaultCompilerPasses, emitSymbolModules, emitSymbolResolverModule, lowerStateAccess, planPayloadArena, planSymbolResolver, renderPayloadScriptArtifact, validateCompilerPassGraph };